...
int main(){
    ...
    Ret = PerformeBinarySearchAlgorithm_1(MyData, 0, DATA_MAX_SIZE-1, 22); // 2
    printf("Ret = %i \n", Ret);
    Ret = PerformeBinarySearchAlgorithm_1(MyData, 0, DATA_MAX_SIZE-1, 77); // 7
    printf("Ret = %i \n", Ret);
    Ret = PerformeBinarySearchAlgorithm_1(MyData, 0, DATA_MAX_SIZE-1, 100); // -1
    printf("Ret = %i \n", Ret);
    printf("************************************************\n");
